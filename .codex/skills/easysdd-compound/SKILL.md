...
description: easysdd-compound 是 easysdd 的知识沉淀子工作流——在完成任何非 trivial 的功能开发、问题修复或工程实践后，将关键学习点提炼并归档为可复用的文档，让同类问题的下次处理从数小时缩短到数分钟。当用户提到"记录学到的东西"、"沉淀知识"、"compound"、"document learnings"、"把这次经验记下来"、"归档一下"，或在完成 feature/issue 工作流后想留存经验时，触发本技能。如果用户在 easysdd-feature-acceptance 或 easysdd-issue-fix 结束后没有主动提及，AI 应轻推一次"要记录这次的学习点吗？"——用户说"不用"则立即跳过。
---
