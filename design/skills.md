...
```
~/.agent/skills/rust/SKILL.md          — 跨工具共享：Rust 工作流
~/.agents/skills/find-skills/SKILL.md  — 兼容现有代理生态：共享技能目录
~/.agent/skills/git/SKILL.md           — 跨工具共享：Git 提交规范
~/.march/skills/api-style/SKILL.md     — March 专用：本项目 API 风格约定
.march/skills/deploy/SKILL.md          — 项目级：部署流程
```
...
```
1. 跨工具共享级  — ~/.agent/skills/*/SKILL.md
2. 跨工具共享级(兼容) — ~/.agents/skills/*/SKILL.md
3. 用户级        — ~/.march/skills/*/SKILL.md
4. 项目级        — .march/skills/*/SKILL.md
```
...
```
可用 Skills：
- rust  (~/.agent/skills/rust/SKILL.md)：Rust 项目工作流
- rust  (~/.agent/skills/rust/SKILL.md)：Rust 项目工作流 [auto: detected Cargo.toml]
- git   (~/.agent/skills/git/SKILL.md)：Git 提交规范
- api-style  (.march/skills/api-style/SKILL.md)：本项目 API 风格约定
