...
| Capability | Anthropic 格式 | OpenAI 格式 | Gemini 格式 |
|------------|---------------|-------------|-------------|
| WebSearch | `type: "web_search_20250305"` | `type: "web_search_preview"` | `google_search` retrieval |
| CodeExecution | `type: "code_execution_20250522"` | `type: "code_interpreter"` | `code_execution` |
